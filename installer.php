...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230208_lesiteduvin_gilles_1278be08c996266a6470_20230208110341_archive.zip';
        const ARCHIVE_SIZE       = '62697776';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1278be0-08110341';
        const SECONDARY_PACKAGE_HASH = '02a6661-08110341';
